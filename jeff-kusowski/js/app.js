...
function displayPics(){
  ...
  // rando is now scope constrained to the while loop that it is in.  The console.log in line 37 is outside of that scope, so it throws an error when it tries to use rando.
  console.log(viewed)
